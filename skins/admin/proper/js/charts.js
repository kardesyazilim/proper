...
$(document).ready(function() {
    ...
    if (divElement.hasClass('simple-donut')) {
        $(function() {
            var data = [
                {label: "angara", data: 38, color: "#88bbc8"},
                {label: "mp3", data: 23, color: "#ed7a53"},
                {label: "s3 mini", data: 15, color: "#9FC569"},
                {label: "lego", data: 9, color: "#bbdce3"},
                {label: "pil", data: 7, color: "#9a3b1b"},
                {label: "lcd", data: 5, color: "#5a8022"},
                {label: "nokia", data: 3, color: "#2c7282"}
            ];
    ...
    if (divElement.hasClass('simple-pie')) {
        $(function() {
            var data = [
                {label: "GOOGLE", data: 38, color: "#88bbc8"},
                {label: "BING", data: 23, color: "#ed7a53"},
                {label: "YAHOO", data: 15, color: "#9FC569"},
                {label: "AD", data: 9, color: "#bbdce3"},
                {label: "AKAKÇE", data: 7, color: "#9a3b1b"},
                {label: "MAIL", data: 5, color: "#5a8022"},
                {label: "SOSYAL MEDYA", data: 3, color: "#2c7282"}
            ];
    ...
    if (divElement.hasClass('order-bars-chart')) {
        $(function() {
            ...
            var d3 = [];
            for (var i = 0; i <= 24; i += 1)
                d3.push([i, parseInt(Math.random() * 3)]);
    ...
    if (divElement.hasClass('stacked-bars-chart')) {
        $(function() {
            ...
            var d2 = [];
            for (var i = 0; i <= 24; i += 1)
                d2.push([i, parseInt(Math.random() * 1500)]);
            var ds = new Array();
            ...
            var options = {
                ...
                series: {
                    ...
                    bars: {show: bars, barWidth: 0.3, fill: 1}
                },
