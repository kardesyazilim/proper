	...
	(function(){
		supr_switcher = {
			create : function () {
				...
				$('body').append('<div id="switcher"><h4>Üst Menü</h4><div class="header-patterns"><ul><li><a href="#" class="hpat1"><img src="media/ext/images/patterns/header/1.png"></a></li><li><a href="#" class="hpat2"><img src="media/ext/images/patterns/header/2.png"></a></li><li><a href="#" class="hpat3"><img src="media/ext/images/patterns/header/3.png"></a></li><li><a href="#" class="hpat4"><img src="media/ext/images/patterns/header/4.png"></a></li></ul></div><h4>Yan Menu</h4><div class="sidebar-patterns"><ul><li><a href="#" class="spat1"><img src="media/ext/images/patterns/sidebar/1.png"></a></li><li><a href="#" class="spat2"><img src="media/ext/images/patterns/sidebar/2.png"></a></li><li><a href="#" class="spat3"><img src="media/ext/images/patterns/sidebar/3.png"></a></li><li><a href="#" class="spat4"><img src="media/ext/images/patterns/sidebar/4.png"></a></li></ul></div><h4>Body</h4><div class="body-patterns"><ul><li><a href="#" class="bpat1"><img src="media/ext/images/patterns/body/1.png"></a></li><li><a href="#" class="bpat2"><img src="media/ext/images/patterns/body/2.png"></a></li><li><a href="#" class="bpat3"><img src="media/ext/images/patterns/body/3.png"></a></li><li><a href="#" class="bpat4"><img src="media/ext/images/patterns/body/4.png"></a></li></ul></div></div>');
			},
			init: function() {
				supr_switcher.create();
				$('#switcher a').click(function() {
					if($(this).hasClass('hpat1')) {$('#header').css('background', 'url(media/ext/images/patterns/header/bedge_grunge.png)');}
					if($(this).hasClass('hpat2')) {$('#header').css('background', 'url(media/ext/images/patterns/header/grid.png)');}
					if($(this).hasClass('hpat3')) {$('#header').css('background', 'url(media/ext/images/patterns/header/nasty_fabric.png)');}
					if($(this).hasClass('hpat4')) {$('#header').css('background', 'url(media/ext/images/patterns/header/natural_paper.png)');}
					if($(this).hasClass('spat1')) {$('#sidebarbg').css('background', 'url(media/ext/images/patterns/sidebar/az_subtle.png)');}
					if($(this).hasClass('spat2')) {$('#sidebarbg').css('background', 'url(media/ext/images/patterns/sidebar/billie_holiday.png)');}
					if($(this).hasClass('spat3')) {$('#sidebarbg').css('background', 'url(media/ext/images/patterns/sidebar/grey.png)');}
					if($(this).hasClass('spat4')) {$('#sidebarbg').css('background', 'url(media/ext/images/patterns/sidebar/noise_lines.png)');}
					if($(this).hasClass('bpat1')) {$('#content').css('background', 'url(media/ext/images/patterns/body/cream_dust.png)');}
					if($(this).hasClass('bpat2')) {$('#content').css('background', 'url(media/ext/images/patterns/body/dust.png)');}
					if($(this).hasClass('bpat3')) {$('#content').css('background', 'url(media/ext/images/patterns/body/grey.png)');}
					if($(this).hasClass('bpat4')) {$('#content').css('background', 'url(media/ext/images/patterns/body/subtle_dots.png)');}					
				});
	...
	$( '.collapseBtn' ).bind( 'click', function(){
		...
		if ($this.hasClass('leftbar')) {
			...
			if($(this).hasClass('hide')) {
				...
				$this.children('a').attr('title','Menüyü Gizle');
				...
				//expand content
				$this.addClass('hide');
				$this.children('a').attr('title','Menüyü Göster');
				if($('#content').length) {
					$('#content').css('margin-left', '0');
				}
				if($('#content-two').length) {
